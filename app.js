    ...
    return (
        <div className="bg-white dark:bg-gray-800/50 rounded-3xl shadow-lg p-3 sm:p-6 mb-4 sm:mb-6 relative border-4 border-blue-200 dark:border-gray-700" id="weeklyCalendarSection">
            ...
            <div className="overflow-x-auto">
                <table className="w-full min-w-[40rem] divide-y divide-gray-200 dark:divide-gray-700 rounded-lg">
                                        ...
                                        >
                                            <div className="flex flex-col space-y-1">
                                                {classesInSlot.map(cls => (
                                                    <div key={cls.id} className="bg-blue-100 dark:bg-blue-900/50 text-blue-800 dark:text-blue-200 text-xs font-medium rounded-md px-1 py-0.5 group">
                                                        <p className="truncate" title={`${cls.subject} (${cls.description})`}>{cls.subject}</p>
...
const AcademicTaskManager = ({ user }) => {
    ...
    return (
        <div className="min-h-screen bg-gray-100 dark:bg-gray-900">
            ...
            {/* FAB Button */}
            <button onClick={handleOpenNewTaskModal} className="absolute bottom-6 right-6 bg-red-600/90 backdrop-blur-sm text-white rounded-full p-4 shadow-lg hover:bg-red-700 transition-all transform hover:scale-110 z-40 xl:right-32 2xl:right-72">
