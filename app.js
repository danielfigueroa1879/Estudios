...
const TaskModal = ({ isOpen, onClose, onSave, showAlert, taskToEdit, selectedDate }) => {
    ...
    return (
        <div className="fixed inset-0 bg-black/60 flex items-center justify-center z-50 p-2">
            <div className="bg-white dark:bg-gray-800 rounded-3xl shadow-2xl p-6 sm:p-8 w-[99%] max-w-2xl mx-auto border border-gray-200 dark:border-gray-700">
                    ...
                    <div className="max-w-6xl mx-auto px-3 sm:px-6">
                        <div className="flex items-center justify-between">
                            <div className="flex items-center space-x-2">
                                ...
                                <div>
                                    <h1 className="text-xl sm:text-3xl font-bold text-white leading-tight">GESTOR ACADÉMICO</h1>
