        ...
        <div className="relative">
            ...
            <div className="grid grid-cols-7 border-l border-t border-gray-200 dark:border-gray-700">
                {daysArray.map((day, index) => {
                    if (!day) return <div key={index} className="h-14 sm:h-20 lg:h-28 bg-gray-50 dark:bg-gray-800/30 border-r border-b border-gray-200 dark:border-gray-600"></div>;
        ...
        if (completed) {
            ...
            switch (status) {
                case 'overdue':
                    ...
                    break;
                case 'due-today':
                    baseStyles = { bg: 'bg-red-50 dark:bg-red-900/80', border: 'border-red-500 dark:border-red-600', text: 'text-red-800 dark:text-red-200' };
                    ...
                    highlightBg = 'bg-red-200 dark:bg-red-800/90';
                    break;
                case 'due-tomorrow':
                    baseStyles = { bg: 'bg-orange-50 dark:bg-orange-900/80', border: 'border-orange-400 dark:border-orange-500', text: 'text-orange-800 dark:text-orange-200' };
                    ...
                    highlightBg = 'bg-orange-200 dark:bg-orange-800/90';
                    break;
                case 'due-soon':
                    baseStyles = { bg: 'bg-yellow-50 dark:bg-yellow-900/80', border: 'border-yellow-400 dark:border-yellow-500', text: 'text-yellow-800 dark:text-yellow-200' };
                    ...
                    highlightBg = 'bg-yellow-200 dark:bg-yellow-800/90';
                    break;
                default: // 'on-time'
                    baseStyles = { bg: 'bg-green-50 dark:bg-green-900/80', border: 'border-green-400 dark:border-green-500', text: 'text-green-800 dark:text-green-200' };
                    ...
                    highlightBg = 'bg-green-200 dark:bg-green-800/90';
                    break;
            }
        }
