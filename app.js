...
const MiniWeeklyCalendar = ({ classes }) => {
    ...
    return (
        <div className="fixed top-20 right-10 z-40 bg-white dark:bg-gray-800 rounded-xl shadow-lg border border-gray-200 dark:border-gray-700 overflow-hidden w-64 block">
