...
const AcademicTaskManager = ({
  ...
  return /*#__PURE__*/React.createElement("div", {
    ...
    className: "w-full md:w-72 lg:w-80 bg-white dark:bg-gray-800 rounded-2xl md:rounded-r-none shadow-2xl p-4 md:p-6 md:min-h-screen z-20 transition-all duration-300 transform md:transform-none" style={{ marginLeft: `${isSidebarCollapsed ? '-288px' : '0'}` }}> // Anchura ajustada para el calendario pequeño
  }, /*#__PURE__*/React.createElement("div", {
