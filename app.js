            ...
            <div className="max-w-md w-full mx-auto bg-white rounded-2xl shadow-2xl p-8 border-t-4 border-blue-600">
                ...
                <div className="space-y-6">
                    <div className="relative">
                        ...
                        <input type="email" placeholder="Correo electrónico" value={email} onChange={(e) => setEmail(e.target.value)} className="w-full border border-gray-300 rounded-xl px-12 py-3 text-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent transition" />
                    </div>
                    <div className="relative">
                        <span className="absolute left-4 top-3.5 text-gray-400"><IconLock /></span>
                        <input type="password" placeholder="Contraseña" value={password} onChange={(e) => setPassword(e.target.value)} className="w-full border border-gray-300 rounded-xl px-12 py-3 text-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent transition" />
                    </div>
                </div>
...
const App = () => {
    ...
    useEffect(() => {
        ...
        // cada vez que el estado de autenticación del usuario cambia.
