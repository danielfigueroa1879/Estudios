        ...
        if (completed) {
            ...
            switch (status) {
                case 'overdue':
                    ...
                    break;
                case 'due-today':
                    baseStyles = { bg: 'bg-red-50 dark:bg-red-900/70', border: 'border-red-500 dark:border-red-700', text: 'text-red-800 dark:text-red-200' };
                    ...
                    break;
                case 'due-tomorrow':
                    baseStyles = { bg: 'bg-orange-50 dark:bg-orange-900/70', border: 'border-orange-400 dark:border-orange-600', text: 'text-orange-800 dark:text-orange-200' };
                    ...
                    break;
                case 'due-soon':
                    baseStyles = { bg: 'bg-yellow-50 dark:bg-yellow-900/70', border: 'border-yellow-400 dark:border-yellow-600', text: 'text-yellow-800 dark:text-yellow-200' };
                    ...
                    break;
                default: // 'on-time'
                    baseStyles = { bg: 'bg-green-50 dark:bg-green-900/70', border: 'border-green-400 dark:border-green-600', text: 'text-green-800 dark:text-green-200' };
