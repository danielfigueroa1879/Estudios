...
// --- NEW: Weekly Calendar View Component (CORREGIDO) ---
                                        ...
                                        >
                                            <div className="flex flex-col space-y-1">
                                                {classesInSlot.map(cls => (
                                                    <div key={cls.id} className="bg-blue-100 dark:bg-blue-900/50 text-blue-800 dark:text-blue-200 text-xs font-medium rounded-md px-2 py-1 group">
                                                        {/* ASIGNATURA EN LA PRIMERA LÍNEA */}
                                                        <div className="font-semibold truncate" title={`${cls.subject} (${cls.description})`}>
                                                            {cls.subject}
                                                        </div>
                                                        
                                                        {/* SALTO DE LÍNEA Y HORA DEBAJO */}
                                                        <div className="text-[0.65rem] text-blue-700 dark:text-blue-300 mt-0.5">
                                                        ...
                                                        <div className="flex space-x-1 opacity-0 group-hover:opacity-100 transition-opacity mt-1">
                                                            <button onClick={() => onEditClass(cls)} className="text-blue-600 dark:text-blue-300 hover:text-blue-800 dark:hover:text-blue-100" title="Editar clase">
                                                                <IconEdit width="12" height="12" />
                                                            </button>
                                                            <button onClick={() => onDeleteClass(cls.id)} className="text-red-600 dark:text-red-300 hover:text-red-800 dark:hover:text-red-100" title="Eliminar clase">
...
// --- NEW: Mini Weekly Calendar Component (CORREGIDO) ---
                                    ...
                                    return (
                                        ...
                                        >
                                            <div className="flex flex-col space-y-0.5">
                                                {classesInSlot.map(cls => (
                                                    <div key={cls.id} className="bg-blue-100 dark:bg-blue-900/50 text-blue-800 dark:text-blue-200 text-[0.6rem] font-medium rounded-sm px-0.5 py-0.5" title={`${cls.subject} (${cls.description})`}>
                                                        {/* ASIGNATURA EN LA PRIMERA LÍNEA */}
                                                        ...
                                                        {/* SALTO DE LÍNEA Y HORA DEBAJO */}
                                                        <div className="text-[0.5rem] text-blue-700 dark:text-blue-300">
                                                            {cls.startTime}{cls.endTime ? ` - ${cls.endTime}` : ''}
                                                        </div>
                                                    </div>
                                                ))}
