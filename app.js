...
const MiniWeeklyCalendar = ({ classes }) => {
    ...
    return (
        <div className="fixed top-24 right-1 z-40 bg-white dark:bg-gray-800 rounded-xl shadow-lg border border-gray-200 dark:border-gray-700 overflow-hidden w-[34rem] hidden md:block">
