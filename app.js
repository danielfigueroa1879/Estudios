        ...
        <div className="relative">
            ...
            <div className="grid grid-cols-7 border-l border-t border-gray-200 dark:border-gray-700">
                {daysArray.map((day, index) => {
                    ...
                    let dayClasses = `h-14 sm:h-20 lg:h-28 p-0.5 sm:p-1 transition-all duration-300 ease-in-out relative border-r border-b border-gray-200 dark:border-gray-600 ${isHoliday ? 'bg-red-50 dark:bg-red-900/50' : ''} ${isToday ? 'bg-blue-100 dark:bg-blue-800/80' : 'bg-white dark:bg-gray-700/90 hover:bg-gray-50 dark:hover:bg-gray-600/90'}`;
    ...
    return (
        <div id="historySection" className="bg-white dark:bg-gray-800 rounded-2xl shadow-lg p-2 sm:p-6 mb-3 sm:mb-6 mt-5 sm:mt-6 space-y-4">
            ...
            {history.map(task => {
                ...
                const cardStyle = isCompleted ? 'bg-green-50 dark:bg-green-900/40 border-green-200 dark:border-green-800/50' : 'bg-red-50 dark:bg-red-900/40 border-red-200 dark:border-red-800/50';
        ...
        if (completed) {
            ...
            switch (status) {
                case 'overdue':
                    ...
                    break;
                case 'due-today':
                    baseStyles = { bg: 'bg-red-50 dark:bg-red-900/40', border: 'border-red-500 dark:border-red-600', text: 'text-red-800 dark:text-red-200' };
                    ...
                    break;
                case 'due-tomorrow':
                    baseStyles = { bg: 'bg-orange-50 dark:bg-orange-900/40', border: 'border-orange-400 dark:border-orange-500', text: 'text-orange-800 dark:text-orange-200' };
                    ...
                    break;
                case 'due-soon':
                    baseStyles = { bg: 'bg-yellow-50 dark:bg-yellow-900/40', border: 'border-yellow-400 dark:border-yellow-500', text: 'text-yellow-800 dark:text-yellow-200' };
                    ...
                    break;
                default: // 'on-time'
                    baseStyles = { bg: 'bg-green-50 dark:bg-green-900/40', border: 'border-green-400 dark:border-green-500', text: 'text-green-800 dark:text-green-200' };
